<template>
  ...
  >
    <el-row class="h-full">
      <el-col class="flex flex-col h-full overflow-y-hidden" :span="24">
        ...
        <el-card class="enter-y flex-1" header="报废产品列表" :body-style="{ height: 'calc(100% - 45px)' }">
          <DataTable
            :showToolbar="true"
...
export default defineComponent({
  ...
  setup() {
    ...
    async function handlerSubmit() {
      ...
      params['sql_name'] = 'getScrappedProductInfos'
